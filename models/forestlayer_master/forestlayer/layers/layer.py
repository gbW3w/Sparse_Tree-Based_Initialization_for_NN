...
from ..estimators.kfold_wrapper import get_estimator_kfold, get_dist_estimator_kfold, EstimatorConfig
from ..estimators.kfold_wrapper import SplittingKFoldWrapper, CascadeSplittingKFoldWrapper
from ..backend.backend import get_num_nodes
...
class AutoGrowingCascadeLayer(Layer):
    ...
    def fit(self, x_trains, y_train):
        ...
        try:
            ...
            # wash the fit cascades after optimal layer id to save memory
            if self.keep_in_mem:
                for li in range(opt_layer_id + 1, layer_id):
                    pass#self.layer_fit_cascades[li] = None
            return x_cur_train
