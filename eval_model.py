...
def create_eval_pkl(method:str, data_name: str, n_splits: int, n_repeats: int, n_max: int, one_hot: bool=False, in_suffix: str='', out_suffix: str='',
    ...
    with open(f'HP_setting{eval_suffix}/{method}/{data_name}{in_suffix}.yaml') as file:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_repeats', default=5, type=int, help='number of times cross-validation is repeated.')
    ...
    parser.add_argument('-out', '--out_suffix', default='', help='suffix to output file name')
    ...
    create_eval_pkl(method=args.model, data_name=args.data, n_splits=args.n_splits, n_repeats=args.n_repeats, n_max=args.n_max, one_hot=False, 
        in_suffix=args.in_suffix, out_suffix=args.out_suffix, eval_suffix='')